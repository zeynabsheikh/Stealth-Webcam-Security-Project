...
* **Stealth Capture:** Once the user clicks "Allow," the camera records in the background without a visible preview.

* **Phase 1 (Local Storage):** Automatically records and downloads a 7-second video clip to the local machine as a .webm file.
